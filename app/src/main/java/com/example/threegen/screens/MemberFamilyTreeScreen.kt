            ...
            LazyColumn(modifier = Modifier.fillMaxSize()) {
                ...
                item {
                    CollapsibleFamilyTreeItem(
                        ...
                        expandedMemberIds = getExpandedMemberIds(memberId, members),
...
fun getExpandedMemberIds(memberId: Int, members: List<ThreeGen>): Set<Int> {
    val expandedMemberIds = mutableSetOf<Int>()
