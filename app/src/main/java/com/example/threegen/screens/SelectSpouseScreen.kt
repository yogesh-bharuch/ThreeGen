...
fun SelectSpouseScreen(
    ...
    Column(
        ...
        Text(
            text = "Search by Short Name BYVT Bela Yogesh Vyas Thavad",
                ...
                ListItem(
                    ...
                    supportingContent = { Text("Short Name: ${member.shortName}") },
                        ...
                        .clickable {
                            ...
                            currentMemberId?.let {
                               // Log.d("SelectMemberScreen", "Current Member ID: $it Current spouse ID: $member.id")
                                viewModel.updateSpouseId(it, member.id)
